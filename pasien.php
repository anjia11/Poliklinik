...
<div class="container">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <?php
            $result = mysqli_query($mysqli, "SELECT ps.nama, ps.no_rm, pr.tgl_periksa, pr.catatan, GROUP_CONCAT(o.nama_obat) AS nama_obat, pr.biaya_periksa FROM pasien AS ps
                                                ...
                                                WHERE jp.id_dokter  =  '". $_SESSION['id_dokter'] . "'
                                                GROUP BY dep.id_periksa
